      ...
      <div class="row">
        ...
        <div class="col m3">
          ...
          <div class="card round white">
            <div class="container">
             ...
             <p><i class="fa fa-birthday-cake fa-fw margin-right text-theme"></i> January 1st, 1999</p>
            </div>
          </div>
          <br>
          ...
          <div class="card round">
            <div class="white">
             ...
             <br>
               <div class="half">
                 <img src="" style="width:100%" class="margin-bottom">
               </div>
               <div class="half">
                 <img src="" style="width:100%" class="margin-bottom">
               </div>
        ...
        <div class="col m7">
            ...
            <div class="col m12">
              <div class="card round white">
                <div class="container padding">
                  <h6 class="opacity"></h6>
                  <p contenteditable="true" class="border padding">Status: Feeling Pumped</p>
          ...
          <div class="container card white round margin"><br>
            <img src="" alt="Avatar" class="left circle margin-right" style="width:60px">
            <span class="right opacity">1 min</span>
            <h4>John Doe</h4><br>
            <hr class="clear">
            <p>Who is trying to go on a jog with me? :D </p>
              <div class="row-padding" style="margin:0 -16px">
                <div class="half">
                  <img src="" style="width:100%" alt="Northern Lights" class="margin-bottom">
                </div>
                <div class="half">
                  <img src="" style="width:100%" alt="Nature" class="margin-bottom">
              </div>
            </div>
          ...
          <div class="container card white round margin"><br>
            ...
            <h4>Jane Doe</h4><br>
            <hr class="clear">
            <p>Just got back from the gym. New deadlift PR set. Feeling good!</p>
            <button type="button" class="button theme-d1 margin-bottom"><i class="fa fa-thumbs-up"></i>  Like</button> 
            <button type="button" class="button theme-d2 margin-bottom"><i class="fa fa-comment"></i>  Comment</button> 
          </div>  
